...
@WebServlet("/TeacherUploadServlet")
@MultipartConfig
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (filePart != null) {
            ...
            try {
                ...
                String sql = "UPDATE teachers SET image = ? WHERE teacher_id = ?";
                ...
                if (row > 0) {
                    response.sendRedirect("teacherInterface.jsp?status=uploadsuccess");
                } else {
                    response.sendRedirect("teacherInterface.jsp?status=uploadfail");
                }
            } catch (Exception e) {
